  ...
  return (
    <Box
      ...
      sx={{
        ...
        "& .leaflet-control": { zIndex: "0 !important" },
        "& .leaflet-pane": { zIndex: "0 !important" },
        "& .leaflet-top, .leaflet-bottom": { zIndex: "0 !important" },
    ...
    >
      ...
      <Box
        ...
        center={[51.505, -0.09]}
      >
        <TileLayer attribution="meow" noWrap url={tileUrl} />
