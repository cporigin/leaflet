/**
 * this env extends node-env version 0.0.25.
 * to inspect its config @see https://bit.cloud/teambit/node-env?version=0.0.25
 * */
...
export class MyNodeEnvEnv extends NodeEnv {
...
export default new MyNodeEnvEnv();
